...
Defines the architecture of the QuIIN Shiny application: bootstrap sequence, module loading, database initialization, background process management, UI structure, Google Drive synchronization, and real-time progress tracking.
