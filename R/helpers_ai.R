...
skill_verify_metadata <- function(metadata, raw_text, log_path = NULL) {
  ...
  prompt <- paste(
    ...
    "",
    "1. E_EDITAL_FOMENTO e MOTIVO_DESCARTE: O texto realmente representa um edital de fomento ou oportunidade de financiamento/bolsa?",
    "   - Se for um manual administrativo, procedimentos de relatórios, plano estratégico geral, notícias ou guia informativo geral (não-edital), certifique-se de que 'e_edital_fomento' seja false e 'motivo_descarte' indique claramente a razão.",
